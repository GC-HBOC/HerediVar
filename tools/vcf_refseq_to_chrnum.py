...
# more complete mapping table for chromosome accession numbers: https://github.com/biocommons/uta/blob/main/misc/EnsemblUTA/ensembl_90/GRCh37.90/name_to_accession.py
...
for line in input_file:
    ...
    if line.startswith('#'):
        ...
        if current_refseq_id in refseq_dict:
            chrom = refseq_dict.get(current_refseq_id)
            if chrom is not None: # skips all alt, decoy etc contigs
                line[0] = chrom
                print('\t'.join(line))