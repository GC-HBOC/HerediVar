...
$ngsbits/VcfLeftNormalize -in priors_hg19.vcf -ref $grch37 -out priors_hg19.normalized.vcf
mv priors_hg19.normalized.vcf priors_hg19.vcf
...
# these are already availab ein grch38 positions
...
$ngsbits/VcfLeftNormalize -in priors.vcf -ref $grch38 -out priors.normalized.vcf
mv priors.normalized.vcf priors.vcf
$ngsbits/VcfSort -in priors.vcf -out priors.vcf


$ngsbits/VcfCheck -in priors.vcf -ref $grch38 > vcferrors.txt
...
#python3 /mnt/storage2/users/ahdoebm1/MaxEntScanStats/src/vcf_check_duplicates/main.py
#python3 /mnt/storage2/users/ahdoebm1/MaxEntScanStats/src/vcf_check_duplicates/merge_positions.py
