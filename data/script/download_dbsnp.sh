...
wget -O - https://ftp.ncbi.nih.gov/snp/archive/b$version/VCF/GCF_000001405.39.gz | gunzip | python3 $dbconverter | $ngsbits/VcfBreakMulti | $ngsbits/VcfLeftNormalize -stream -ref $grch38 | $ngsbits/VcfStreamSort > dbSNP.vcf
bgzip dbSNP.vcf
