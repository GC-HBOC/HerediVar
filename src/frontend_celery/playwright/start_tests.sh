...
pytest --screenshot=only-on-failure --browser firefox tests/read_only/ -k 'test_variant_string_search' #-k 'test_dev' --browser webkit --browser chromium --numprocesses 2
