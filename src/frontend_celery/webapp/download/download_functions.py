...
def get_possible_classes_enigma_insight_mmr_200(class_counts):
    #print(class_counts)
    possible_classes = set()
    ...
    if class_counts['pvs'] >= 2:
        possible_classes.add(5)
    if class_counts['pvs'] == 1:
        if class_counts['ps'] >= 1 or class_counts['pm'] >= 2 or class_counts['pp'] >= 2 or (class_counts['pm'] == 1 and class_counts['pp'] == 1):
            possible_classes.add(5)
    if class_counts['ps'] >= 2:
        possible_classes.add(5)
    if class_counts['ps'] == 1:
