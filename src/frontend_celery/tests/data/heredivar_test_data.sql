...
INSERT INTO `variant_literature` VALUES 
	...
	(31,52,9425226,'Mutations in the BRCA1-associated RING domain (BARD1) gene in primary breast, ovarian and uterine cancers.','T H Thai, F Du, J T Tsan, Y Jin, A Phung, M A Spillman, H F Massa, C Y Muller, R Ashfaq, J M Mathis, D S Miller, B J Trask, R Baer, A M Bowcock','Human molecular genetics',1998),
	(32,52,15342711,'Mutation screening of the BARD1 gene: evidence for involvement of the Cys557Ser allele in hereditary susceptibility to breast cancer.','S-M Karppinen, K Heikkinen, K Rapakko, R Winqvist','Journal of medical genetics',2004),
	(33,52,16333312,'BARD1 variants Cys557Ser and Val507Met in breast cancer predisposition.','Pia Vahteristo, Kirsi Syrjäkoski, Tuomas Heikkinen, Hannaleena Eerola, Kristiina Aittomäki, Karl von Smitten, Kaija Holli, Carl Blomqvist, Olli-Pekka Kallioniemi, Heli Nevanlinna','European journal of human genetics : EJHG',2006),
...
INSERT INTO `user_variant_lists` VALUES 
	(8,4,'second list update');
UNLOCK TABLES;


--
-- fill some scheme classifications
--

LOCK TABLES `scheme_classification` WRITE;
INSERT INTO `scheme_classification` VALUES 
	(27,15,'acmg_standard','2022-08-03',0),
	(28,15,'acmg_standard','2022-07-19',1),
	(29,15,'acmg_TP53','2022-07-19',0),
	(30,15,'acmg_standard','2022-07-19',1),
	(36,15,'acmg_CDH1','2022-07-21',0),
	(41,15,'task-force','2022-07-27',1),
	(65,15,'task-force-brca','2022-08-09',0),
	(31,139,'acmg_CDH1','2022-07-19',1),
	(32,139,'acmg_CDH1','2022-07-19',0);
UNLOCK TABLES;

LOCK TABLES `scheme_consensus_classification` WRITE;
INSERT INTO `scheme_consensus_classification` VALUES 
	(11,28,3,0),
	(12,30,3,0),
	(13,31,3,1),
	(18,41,3,0);
...
LOCK TABLES `scheme_user_classification` WRITE;
INSERT INTO `scheme_user_classification` VALUES 
	(13,27,3),
	(14,29,3),
	(15,32,3),
	(17,36,3),
