...
CREATE TABLE `HerediVar`.`list_variant_import_queue` (
...
ALTER TABLE `HerediVar`.`list_variant_import_queue` 
CHANGE COLUMN `requested_at` `requested_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP() ;


GRANT SELECT,INSERT,UPDATE ON HerediVar.list_variant_import_queue TO 'HerediVar_user';
GRANT SELECT,INSERT,UPDATE ON HerediVar.list_variant_import_queue TO 'HerediVar_superuser';
GRANT SELECT,INSERT,UPDATE ON HerediVar.list_variant_import_queue TO 'HerediVar_read_only';
