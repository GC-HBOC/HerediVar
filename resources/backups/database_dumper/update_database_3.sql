...
-- 
-- 
-- CREATE TABLE `HerediVar`.`automatic_classification` (
...
-- 
-- 
-- CREATE TABLE `HerediVar`.`automatic_classification_criteria_applied` (
--   `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
--   REFERENCES `HerediVar`.`automatic_classification` (`id`)
--   ON DELETE NO ACTION
--   ON UPDATE NO ACTION;
-- 
-- 
...
-- 
-- 
-- GRANT SELECT, INSERT, UPDATE, DELETE ON HerediVar.automatic_classification TO 'HerediVar_annotation';
-- GRANT SELECT ON HerediVar.automatic_classification TO 'HerediVar_user';
-- GRANT SELECT ON HerediVar.automatic_classification TO 'HerediVar_superuser';
-- GRANT SELECT ON HerediVar.automatic_classification TO 'HerediVar_read_only';
-- 
-- GRANT SELECT, INSERT, UPDATE, DELETE ON HerediVar.automatic_classification_criteria_applied TO 'HerediVar_annotation';
-- GRANT SELECT ON HerediVar.automatic_classification_criteria_applied TO 'HerediVar_user';
-- GRANT SELECT ON HerediVar.automatic_classification_criteria_applied TO 'HerediVar_superuser';
-- GRANT SELECT ON HerediVar.automatic_classification_criteria_applied TO 'HerediVar_read_only';
-- 
-- 
-- 
-- GRANT SELECT ON HerediVar.assay TO 'HerediVar_annotation';
-- 
-- 
-- ALTER TABLE `HerediVar`.`task_force_protein_domains` 
...
-- 
-- 
-- CREATE TABLE `HerediVar`.`mutually_inclusive_criteria` (
--   `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
--   ON UPDATE NO ACTION;
-- 
-- GRANT SELECT ON HerediVar.mutually_inclusive_criteria TO 'HerediVar_user';
-- GRANT SELECT ON HerediVar.mutually_inclusive_criteria TO 'HerediVar_superuser';
-- GRANT DELETE,INSERT ON HerediVar.mutually_inclusive_criteria TO 'HerediVar_superuser';
-- 
-- 
-- 
-- ALTER TABLE `HerediVar`.`mutually_inclusive_criteria` 
